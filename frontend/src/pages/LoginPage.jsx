    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1
            className="font-display text-[32px] font-normal leading-tight"
        ...
        >
            ...
            <form onSubmit={handleDevLogin}>
              <div style={{ marginBottom: 20 }}>
                ...
                <input
                  type="text"
                  value={devSession}
                  onChange={e => setDevSession(e.target.value)}
              ...
              >
                {loading ? (
                  ...
                  <>Connect Session <ArrowRight size={14} /></>
                )}
              </button>
            </form>
          )}
          ...
          <div className="mt-4 pt-4" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
            <button
              type="button"
              onClick={() => { setShowDevLogin(!showDevLogin); setError(''); }}
              className="flex items-center gap-2 w-full justify-center text-[12px] transition-colors"
              style={{ color: 'var(--color-text-dim)', background: 'none', border: 'none', cursor: 'pointer' }}
            >
              <KeyRound size={12} />
              {showDevLogin ? 'Use credentials instead' : 'Dev login (JSESSIONID)'}
            </button>
          </div>
        </div>
      </motion.div>
